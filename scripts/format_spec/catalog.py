...
"""Reusable marker paired with ``class=review`` while a PDF awaits review.

Keep this dormant between reviews. It preserves the approved yellow highlight,
red rule and outlined label without leaving review marks in the document.
"""
